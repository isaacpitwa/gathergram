      ...
      <section className=" flex flex-col sectionWrapper py-16 items-center" id="features">
        ...
        <div className="bg-black pt-2 flex flex-col md:flex-row">
                <div className="pt-20 pb-8 px-6">
                    <img src={EventsManagementIcon} alt="Event management" />
                ...
                <div className="pt-20 pb-8 px-6 bg-light_pink ">
                    <img src={GuestInteractionIcon} alt="Guest Interaction" />
                ...
                <div className="pt-20 pb-8 px-6">
                <img src={DonateContributeIcon} alt="Donate & Contribute" />
                ...
                <div className="pt-20 pb-8 px-6">
                  <img src={CustomLoveStoryIcon} alt="Custom Love Story Page" />
